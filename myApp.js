...
var createAndSavePerson = function(done) {
  var johnSmith = new Person({name: "John Smith", age: 35, favoriteFoods: ["Turkey", "Dressing"]})
...
/*var arrayOfPeople = [
  {name: "Sammy", age: 60, favoriteFoods: ["Tacos"]},
  {name: "Dean", age: 60, favoriteFoods: ["Italian"]},
  {name: "Frank", age: 60, favoriteFoods: ["Hamburger"]}
]*/
